...
public class centralProxyActivity extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "com.Company.ProductName.centralActivity", "com.Company.ProductName.centralNativeActivity" };
